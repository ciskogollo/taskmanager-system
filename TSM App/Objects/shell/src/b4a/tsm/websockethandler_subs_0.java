...
try {
		Debug.PushSubsStack("ws_Closed (websockethandler) ","websockethandler",1,__ref.getField(false, "ba"),__ref,64);
...
Debug.locals.put("Reason", _reason);
 BA.debugLineNum = 64;BA.debugLine="Private Sub ws_Closed (Reason As String)";
Debug.ShouldStop(-2147483648);
 BA.debugLineNum = 65;BA.debugLine="CallSub2(Callback, EventName & \"_Closed\", Reason)";
Debug.ShouldStop(1);
...
try {
		Debug.PushSubsStack("ws_Connected (websockethandler) ","websockethandler",1,__ref.getField(false, "ba"),__ref,60);
if (RapidSub.canDelegate("ws_connected")) { return __ref.runUserSub(false, "websockethandler","ws_connected", __ref);}
 BA.debugLineNum = 60;BA.debugLine="Private Sub ws_Connected";
Debug.ShouldStop(134217728);
 BA.debugLineNum = 61;BA.debugLine="CallSub(Callback,  EventName & \"_Connected\")";
Debug.ShouldStop(268435456);
...
{ BA.debugLineNum = 52;BA.debugLine="Else If event = \"notice\" Then";
Debug.ShouldStop(524288);
if (RemoteObject.solveBoolean("=",_event,BA.ObjectToString("notice"))) { 
 BA.debugLineNum = 53;BA.debugLine="Log(\"Noticia: \"&param)";
Debug.ShouldStop(1048576);
websockethandler.__c.runVoidMethod ("LogImpl","72097167",RemoteObject.concat(RemoteObject.createImmutable("Noticia: "),_param),0);
 }}
;
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e16) {
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e16.toString()); BA.debugLineNum = 56;BA.debugLine="Log(\"TextMsg Error: \" & LastException)";
Debug.ShouldStop(8388608);
websockethandler.__c.runVoidMethod ("LogImpl","72097170",RemoteObject.concat(RemoteObject.createImmutable("TextMsg Error: "),websockethandler.__c.runMethod(false,"LastException",__ref.runMethod(false,"getActivityBA"))),0);
 };
